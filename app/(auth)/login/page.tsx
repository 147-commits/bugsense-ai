  ...
  return (
    <div className="glass-panel p-8">
      ...
      {signedUpEmail && !formError && (
        <div className="mb-4 px-3 py-2.5 rounded-lg bg-accent-emerald/10 text-accent-emerald text-sm">
      ...
      {magicSent ? (
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-3">
          ...
          <a href="/forgot-password" className="text-center text-xs text-text-muted hover:text-text-secondary">
            Forgot password?
          </a>
        </form>
      )}
      ...
      <p className="mt-5 text-center text-text-muted text-xs">
        ...
        <a href="/signup" className="text-accent hover:underline">Get started free</a>
      </p>
    </div>
  );
}
